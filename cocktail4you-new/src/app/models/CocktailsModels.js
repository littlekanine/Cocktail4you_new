...
const IngredientSchema = new mongoose.Schema({
    ...
    quantity: { type: [Number, String], required: true }, // Aligné avec le JSON (Number)
...
const CocktailSchema = new mongoose.Schema({
    ...
    decoration: [DecorationSchema], // Ajouté pour inclure les décorations
    instructions: { type: String, required: true },
    category: { type: String, required: true },
    tags: [{ type: String }], // Tableau de chaînes
